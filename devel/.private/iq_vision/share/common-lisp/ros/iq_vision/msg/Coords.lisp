...
(cl:defmethod cl:initialize-instance :after ((m <Coords>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Coords)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iq_vision-msg:<Coords> is deprecated: use iq_vision-msg:Coords instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Coords>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iq_vision-msg:x-val is deprecated.  Use iq_vision-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Coords>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iq_vision-msg:y-val is deprecated.  Use iq_vision-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Coords>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iq_vision-msg:z-val is deprecated.  Use iq_vision-msg:z instead.")
  (z m))
